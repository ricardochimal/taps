...
Gem::Specification.new do |s|
  ...
  s.files = ["spec/base.rb", "spec/schema_spec.rb", "spec/server_spec.rb", "spec/client_session_spec.rb", "spec/utils_spec.rb", "lib/taps/progress_bar.rb", "lib/taps/adapter_hacks.rb", "lib/taps/adapter_hacks/invalid_binary_limit.rb", "lib/taps/adapter_hacks/invalid_text_limit.rb", "lib/taps/adapter_hacks/mysql_invalid_primary_key.rb", "lib/taps/adapter_hacks/non_rails_schema_dump.rb", "lib/taps/schema.rb", "lib/taps/server.rb", "lib/taps/utils.rb", "lib/taps/cli.rb", "lib/taps/db_session.rb", "lib/taps/client_session.rb", "lib/taps/config.rb", "README.rdoc", "LICENSE", "VERSION.yml", "Rakefile", "bin/schema", "bin/schema.cmd", "bin/taps"]
  s.has_rdoc = true
