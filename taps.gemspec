...
Gem::Specification.new do |s|
  ...
  s.files = ["spec/base.rb", "spec/client_session_spec.rb", "spec/schema_spec.rb", "spec/server_spec.rb", "spec/utils_spec.rb", "lib/taps/config.rb", "lib/taps/db_session.rb", "lib/taps/progress_bar.rb", "lib/taps/server.rb", "lib/taps/utils.rb", "lib/taps/schema.rb", "lib/taps/client_session.rb", "lib/taps/cli.rb", "README.rdoc", "LICENSE", "VERSION.yml", "Rakefile", "bin/taps", "bin/schema"]
  s.has_rdoc = true
