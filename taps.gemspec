...
Gem::Specification.new do |s|
  ...
  s.files = ["spec/base.rb", "spec/utils_spec.rb", "spec/server_spec.rb", "spec/schema_spec.rb", "spec/client_session_spec.rb", "lib/taps/db_session.rb", "lib/taps/progress_bar.rb", "lib/taps/cli.rb", "lib/taps/adapter_hacks.rb", "lib/taps/adapter_hacks/invalid_text_limit.rb", "lib/taps/adapter_hacks/non_rails_schema_dump.rb", "lib/taps/schema.rb", "lib/taps/server.rb", "lib/taps/utils.rb", "lib/taps/client_session.rb", "lib/taps/config.rb", "README.rdoc", "LICENSE", "VERSION.yml", "Rakefile", "bin/taps", "bin/schema"]
  s.has_rdoc = true
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<sequel>, ["~> 2.10.0"])
      ...
      s.add_dependency(%q<sequel>, ["~> 2.10.0"])
